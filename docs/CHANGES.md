2018-06-08  Unreleased

  * Feature: Metric sources can be registered with the project or with the domain object they apply to.
    See https://github.com/ICTU/quality-report/wiki/Metric-sources.
